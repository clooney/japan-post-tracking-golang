# Japan Post Tracking API For Golang
Japan Post Tracking API and webhook make it easy to integrate Japan Post Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a Japan Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Japan Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Japan Post Tracking API](https://www.trackingmore.com/japan-post-tracking.html)  to:

   *   Get Japan Post realtime tracking info of muti-carriers in one integration
   *   Provide Japan Post shipment tracking experience like Amazon
   *   Push Japan Post notifications of package update with webhook
   *   Verify Japan Post delivery exception before it is too late
